                ...
                <section class="section_1">
                    <div class="intro_section">
                        <div class="cmn_container">
                            ...
                            <!-- Video -->
                            <video autoplay="autoplay" preload="auto" playsinline="" loop="loop" muted="muted"
                                class="media__video">
                        ...
                        <?php if (!empty($artists)): ?>
                            <div class="artist-slider" x-data="{ scrollPos: 0, maxScroll: 0 }" x-init="maxScroll = $refs.track.scrollWidth - $refs.track.clientWidth">
                                ...
                                <div class="artist-slider-track" x-ref="track">
                                    <?php foreach ($artists as $artist_img): ?>
                                        <?php $artist_slug = sanitize_title($artist_img['name']); ?>
                                        <a href="/gallery/#<?php echo esc_attr($artist_slug); ?>" class="artist-card-link">
                                            <div class="artist-card">
                                                <div class="artist-image">
                                                    <img src="<?php echo esc_url($artist_img['url']); ?>" alt="<?php echo esc_attr($artist_img['alt']); ?>">
                                                </div>
                                                <div class="artist-name"><?php echo esc_html($artist_img['name']); ?></div>
                                            </div>
                                        </a>
                                    <?php endforeach; ?>
                                </div>
    ...
    function bookingForm() {
        return {
            ...
            async submitForm() {
                ...
                // ✅ Validation (fixes your previous error)
                ...
                try {
                    ...
                    // Check for standard error wrapper or Contentful Error body
                    if (result.status === 'error' || (result.entry && result.entry.sys && result.entry.sys.type === 'Error')) {
                        ...
                        // Parse raw string from backend if applicable
                        ...
                        // Deliberately NOT closing the modal so the user can fix the fields!
                    } else {
...
<script>
    ...
    jQuery(function ($) {
        ...
        // 	  var modal = document.getElementById('ghlBookingModal');
        // 	  var openBtn = document.getElementById('openBookingModal');
        // 	  var closeBtn = document.querySelector('.ghl-close');
        // 		const iframe = document.getElementById('oHN0M6e18FAfLByWox01_1753171389626'); // Replace with your iframe ID
        ...
        if (windowWidth >= 991) {
            ...
            window.addEventListener('wheel', function (e) {
                // ✅ If the booking modal is open, let it scroll normally — don't intercept
                const modalOverlay = document.querySelector('.pt-modal-overlay');
                if (modalOverlay && modalOverlay.classList.contains('pt-modal-open')) {
                    return;
                }
...
<div x-data="bookingForm()" @open-booking-modal.window="open = true" x-cloak>

    <!-- Modal Overlay -->
    <div class="pt-modal-overlay" :class="{ 'pt-modal-open': open }"
        @click.self="open = false; step = 1;"
        ...
        <section class="pt-modal-container">
            <div class="pt-modal-inner">
                ...
                <div class="pt-modal-right">
                    <!-- Close button -->
                    <button type="button" @click="open = false; step = 1" class="pt-close-btn">✕</button>
                    <!-- Toast UI -->
                        ...
                        <div x-show="step === 1">
                            ...
                            <div x-ref="step1" class="pt-form-fields-step1">
                                <div class="pt-step-header">
                                    ...
                                    <h3 class="pt-step-subtitle">Tattoo Style Selection</h3>
                        ...
                        <div x-show="step === 4">
                            <div x-ref="step4" class="pt-form-fields">
                                <div>
                                    ...
                                    <h3 class="pt-step-subtitle">Personal Info</h3>
                        ...
                        <div x-show="step === 2">
                            <div x-ref="step2" class="pt-form-fields">
                                <div>
                                    ...
                                    <h3 class="pt-step-subtitle">Where do you want it?</h3>
                                    ...
                                    <div x-show="selectedGender" class="pt-body-map-section">
                                        ...
                                        <div x-show="isImageView" class="pt-body-overlay">
                                            <!-- Top Bar with Title and X -->
                                            <div class="pt-body-overlay-header">
                                                <h3 class="pt-body-overlay-title">Select the body area(s) you would like tattooed</h3>
                                                <button type="button" @click="isImageView = false" class="pt-body-overlay-x">✕</button>
                                            </div>
                                            <!-- View Toggle Buttons -->
                                            <div class="pt-body-overlay-bar">
                                                <div class="pt-body-overlay-buttons">
                                                ...
                                                <template x-if="selectedGender === 'Male' && bodyView === 'front'">
                                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <image overflow="visible"
                                                            href="https://pandatattoo.com/p-content/uploads/2026/04/m-modela.png" />
                                            ...
                                            <div class="pt-body-overlay-footer">
                                                ...
                                                <button type="button" @click="bodyView = (bodyView === 'front' ? 'back' : 'front')" class="pt-body-overlay-btn">
                                                    Back Side
                                                </button>
                                            </div>
                                    ...
                                    <div class="pt-radio-row">
                                        <div class="pt-radio-label-wrap"><label class="pt-radio-main-label pt-hidden-label">Gend</label></div>
                                        <div class="pt-radio-option">
                                            <label class="pt-radio-container group">
                        ...
                        <div x-show="step === 3">
                            <div x-ref="step3" class="pt-form-fields">
                                <div>
                                    ...
                                    <h3 class="pt-step-subtitle">Scheduling</h3>
                                    ...
                                    <div class="pt-radio-row mt-2">
                                        <div class="pt-radio-option">
                                            <label class="pt-radio-container group">
                                                <input type="radio" name="desiredTiming" value="today"
                                                    class="pt-radio-hidden" required>
                                                <span class="pt-radio-button pt-rounded-left">Today</span>
                                            </label>
                                        </div>
                                        <div class="pt-radio-option">
                                            <label class="pt-radio-container group">
